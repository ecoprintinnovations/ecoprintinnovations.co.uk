...
const checks = [
  ...
  ["homepage uses the required engineering-led hero", html.includes("Engineering-led 3D printing for production, protection, and tooling.")],
  ["homepage uses the required feasibility CTA", html.includes("Get a feasibility review")],
  ["homepage includes the required technical hero support copy", html.includes("Send your CAD files, dimensions, and deadlines. We provide technical material recommendations and rapid quotes.")],
