...
const checks = [
  ...
  ["example applications do not imply verified customer outcomes", html.includes("hypothetical enquiries, not customer case studies") && !html.includes("Client industry") && !html.includes("Material used")],
  ...
  ["homepage uses simple illustrative products", ["example-knob.webp", "example-bracket.webp", "example-holder.webp"].every((asset) => html.includes(asset))],
  ["homepage restores the established brand logo", html.includes("logo-brand.webp")],
  ["homepage labels examples honestly", html.includes("Illustrative examples, not completed customer projects")],
